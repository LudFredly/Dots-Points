...
<div class="min-h-screen bg-[var(--color-surface-muted)] flex flex-col font-sans text-[var(--color-text)] selection:bg-emerald-500 selection:text-white">
  <!-- Top Bar -->
  <header class="bg-[var(--ntnui-black-dark)] text-white shadow-md border-b border-[var(--ntnui-black-dark)] sticky top-0 z-30">
    <div class="max-w-5xl mx-auto px-4 py-3 sm:px-6 flex items-center justify-between">
      <div class="flex items-center gap-3">
        <a
          href="/"
          class="inline-flex items-center gap-1.5 px-3 py-1.5 rounded-lg bg-[var(--ntnui-black-dark)] hover:bg-slate-700 text-slate-200 text-xs font-bold transition-all border border-[var(--color-border-strong)]"
        >
